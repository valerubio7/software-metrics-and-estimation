...
- [ ] Comprobar árbol limpio, pruebas y estado del remoto antes de decidir el push; pendiente de revisión final.

## Nota
No publicar hasta verificar la exportación y confirmar la decisión de push.
